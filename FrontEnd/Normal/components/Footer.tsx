  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        "Signaler un problème de quartier"
      ]
    },
    {
      title: "Accueil",
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="flex items-center space-x-4 text-sm text-muted-foreground">
            <span>© 2025 algériebnb, Inc.</span>
            <a href="#" className="hover:text-foreground">Confidentialité</a>
            <a href="#" className="hover:text-foreground">Conditions</a>
            <a href="#" className="hover:text-foreground">Plan du site</a>
          </div>
          
          <div className="flex items-center space-x-4 text-sm text-muted-foreground">
            <a href="#" className="hover:text-foreground">Français (FR)</a>
            <a href="#" className="hover:text-foreground">DA Dinar algérien</a>
